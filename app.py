...
def venues():
  ...
  #   }]
  # }]
  data = Venue.query.group_by(Venue.city)
  print(data)
...
def create_venue_submission():
  ...
  try:
    ...
    v = Venue(name=data['name'],city=data['city'],state=data['state'],address=data['address'],phone=data['phone'],facebook_link=data['facebook_link'],image_link=data['image_link'],genres=data['genres'])
    db.session.add(v)
    db.session.commit()
